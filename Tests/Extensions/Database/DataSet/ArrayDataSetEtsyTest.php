...
require_once 'PHPUnit/Extensions/Database/DataSet/ArrayDataSetEtsy.php';

class Tests_Extensions_Database_DataSet_ArrayDataSetEtsyTest
extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        parent::setUp();
        $this->data_set = new PHPUnit_Extensions_Database_DataSet_ArrayDataSetEtsy(
            array(
                'table_a' => array(
                    array(
                        'id' => 1,
    ...
    public function testEmpty() {
        $data_set = new PHPUnit_Extensions_Database_DataSet_ArrayDataSetEtsy(
            array()
        );
